...

{
    if ($_POST['date'] != "")
    {
        ...
        { //если данный день есть в БД
            ...
            if (isset($_POST['by_24_hour']))
            {
                echo "<p>by_24_hour<p>";
            }
            if (isset($_POST['all_values']))
            {
                echo "<p>all_values<p>";
            }
            $data = File($filename);
        ...
        {
            echo '<p><font size="7"  face="Book antiqua">Замеров за эту дату нет</font>';
        }
    }
...
{
    $html = $html . '<p><font size="7"  face="Book antiqua">Введите дату</font>';
}
echo $html;
?>
                </center>
